...
if binary_method :
    ...
    # test files source 
    test_loader = torch.load("/content/drive/MyDrive/DL_Speech_Denoising/data/test_loader/test_loader.pt", weights_only=False)
    X_test_names = np.load("/content/drive/MyDrive/DL_Speech_Denoising/data/named/names.npy")
    ...
    model = UNet()
    model.to(device) 
    model.load_state_dict(torch.load("/content/drive/MyDrive/DL_Speech_Denoising/models/Unet.pt"))
    model.eval()
    ...
    if not isdir("/content/drive/MyDrive/DL_Speech_Denoising/data/synth_data_soft"):
        os.mkdir("/content/drive/MyDrive/DL_Speech_Denoising/data/synth_data_soft")
    output_dir = "/content/drive/MyDrive/DL_Speech_Denoising/data/synth_data_soft"
    noisy_dataset_dir = "/content/drive/MyDrive/DL_Speech_Denoising/data/noisy_dataset"
    clean_dataset_dir = "/content/drive/MyDrive/DL_Speech_Denoising/data/clean_dataset_norm"
...
if complex_masks_method :
    ...
    # test files source 
    Re_test_loader = torch.load("/content/drive/MyDrive/DL_Speech_Denoising/data/test_loader/Re_test_loader.pt", weights_only=False)
    Im_test_loader = torch.load("/content/drive/MyDrive/DL_Speech_Denoising/data/test_loader/Im_test_loader.pt", weights_only=False)
    X_test_names = np.load("/content/drive/MyDrive/DL_Speech_Denoising/data/named/names.npy")
    ...
    Re_model = UNet()
    Re_model.to(device) 
    Re_model.load_state_dict(torch.load("/content/drive/MyDrive/DL_Speech_Denoising/models/Re_Unet.pt"))
    Re_model.eval()

    Im_model = UNet()
    Im_model.to(device) 
    Im_model.load_state_dict(torch.load("/content/drive/MyDrive/DL_Speech_Denoising/models/Im_Unet.pt"))
    Im_model.eval()
    ...
    if not isdir("/content/drive/MyDrive/DL_Speech_Denoising/data/complex/synth_data"):
        os.mkdir("/content/drive/MyDrive/DL_Speech_Denoising/data/complex/synth_data")
    output_dir = "/content/drive/MyDrive/DL_Speech_Denoising/data/complex/synth_data"
    noisy_dataset_dir = "/content/drive/MyDrive/DL_Speech_Denoising/data/noisy_dataset"
...
if temporal_method:
    ...
    test_loader = torch.load("/content/drive/MyDrive/DL_Speech_Denoising/data/test_loader/test_loader_temp.pt", weights_only=False)
    X_test_names = np.load("/content/drive/MyDrive/DL_Speech_Denoising/data/named/names.npy")
    ...
    if not os.path.isdir("/content/drive/MyDrive/DL_Speech_Denoising/data/synth_data_temp"):
        os.mkdir("/content/drive/MyDrive/DL_Speech_Denoising/data/synth_data_temp")

    output_dir = "/content/drive/MyDrive/DL_Speech_Denoising/data/synth_data_temp"
    clean_dataset_dir = "/content/drive/MyDrive/DL_Speech_Denoising/data/clean_dataset_norm"
